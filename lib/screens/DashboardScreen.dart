            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Task addTask = Task(
                        task: tasktextedit.text, dateTime: DateTime.now(), priority: pp.indexOf(_selectedval!));
              ...
              return Padding(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    String formattedTime = DateFormat('kk:mm:a').format(DateTime.parse(taskData.data[index]['creationTime']));
                    String formattedDate = formatter.format(DateTime.parse(taskData.data[index]['creationTime']));
